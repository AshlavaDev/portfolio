...
export default function ProjectCard({project, projectName, image, briefDescription, keywords}: Props) {
  ...
  return (
    <Link href={{ 
      ...
      <div className='border border-solid border-cream hover:bg-cream rounded text-cream hover:text-burgundy w-80 h-96 p-1 flex flex-col items-center justify-evenly'>
