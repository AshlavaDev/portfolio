...
export default function Contact({}: Props) {
  return (
    <section id='contact' className='min-h-screen w-screen bg-burgundy text-cream relative grid grid-cols-1 md:grid-cols-2 justify-items-center gap-x-20'>
      ...
      <div className='container flex flex-col items-center md:items-start md:pt-36 px-6 pt-10 min-w-full'>
